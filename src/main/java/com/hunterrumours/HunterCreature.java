...
public enum HunterCreature {
    ...
    CHINCHOMPA("Chinchompa", "chinchompa", "Box trap", "Piscatoris Hunter Area, Kourend Woodland, Isle of Souls",1, ItemID.CHINCHOMPA_TUFT),
    ...
    CARNIVOROUS_CHINCHOMPA("Carnivorous chinchompa","carnivorouschinchompa", "Box trap", "Red Chinchompa Hunting Ground, Gwenith Hunter Area, Feldip Hunter Area (a-k-s)",1, ItemID.RED_CHINCHOMPA_TUFT),
    ...
    TECU_SALAMANDER("Tecu salamander", "tecusalamander", "Net trap", "Ralos' Rise",0,ItemID.SALAMANDER_CLAW),
